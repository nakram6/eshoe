...
Description: This file is sigin page for client side
  -->
...
if(isset($_POST['login_btn'])){
  ...
  if($stmt->execute()){
      ...
      if($stmt->num_rows() == 1){
        ...
        header('location: connection.php?login_success=logged in successfully');
                ...
                <form action="signin.php" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="email" id="login-email" name="email"
                            placeholder="Name@email.com" required name="e">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Password</label>
                        <input class="form-control" type="password" id="login-password" name="password"
                            placeholder="Password" required name="p">
                    </div>
                    <div class="mb-3">
                        <button class="btn btn-dark" id="login-btn" name="login_btn" value="Login"
