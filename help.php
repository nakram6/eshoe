...
File Name: help.php
Description: This file is help page
Dated:  08/08/2022
 -->
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div>
        ...
        <p align="center"> Here is a guide of essential and helpful questions to help you navigate your eShoe
            experience. </p>
        <div class="row">
                ...
                <div id="accordionExample" class="accordion">
                    ...
                    <div class="card">
                        <div class="bg-white card-header">
                            <h6><a href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true"
                                    aria-controls="collapseOne"
                                    class="py-1 d-block position-relative text-dark collapsible-link">How would I order
                                    and purchase the shoes I want?</a></h6>
                        </div>
                        <div id="collapseOne" aria-labelledby="headingOne" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body p-4">
                                <p class="font-weight-lighter">You must first create an account in order to access all
                    ...
                    <div class="card">
                        <div class="bg-white card-header">
                            <h6><a href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true"
                                    aria-controls="collapseTwo"
                                    class="py-1 d-block position-relative text-dark collapsible-link">Where can I find
                                    the page to log in or create an account?</a></h6>
                        </div>
                        <div id="collapseTwo" aria-labelledby="headingTwo" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body p-4">
                                <p class="font-weight-lighter">The login page can be found as the human-like silhouette
                                    symbol at the very right of
                                    ...
                                    If you are looking to create an account, just click the hyperlink "Not registered?
                                    Sign up here." which will
                                    redirect you to the Sign-Up page where you can create your account credentials and
                                    log you in once finished successfully.</p>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="bg-white card-header">
                            <h6><a href="#" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true"
                                    aria-controls="collapseThree"
                                    class="py-1 d-block position-relative text-dark collapsible-link">What if I have a
                                    question or concern about the product I want or order I made?</a></h6>
                        </div>
                        <div id="collapseThree" aria-labelledby="headingThree" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body p-4">
                                <p class="font-weight-lighter"> If you have any issues or inquiries that you would like
                                    mention or report to us,
                    ...
                    <div class="card">
                        <div class="bg-white card-header">
                            <h6><a href="#" data-toggle="collapse" data-target="#collapseFour" aria-expanded="true"
                                    aria-controls="collapseFour"
                                    class="py-1 d-block position-relative text-dark collapsible-link">Where can I find
                                    out more about eShoe?</a></h6>
                        </div>
                        <div id="collapseFour" aria-labelledby="headingFour" data-parent="#accordionExample"
                            class="collapse">
                            <div class="card-body p-4">
                                <p class="font-weight-lighter"> Click on the site menu's "About" button if you would
                                    like to learn more about our platform's mission.</p>
                            </div>
                        </div>
                    </div>
