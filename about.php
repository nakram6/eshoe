...
File Name: about.php
Description: This file is about page
Dated:  08/08/2022
 -->
...
<body>
    ...
    <div class="container my-5">
        <h1 class="card-title mb-5 text-center">About</h1>
        <div class="card">
            <div class="card-body">
                <p class="text-left"> eShoe is a eCommerce platform where our company's <i> sole </i> mission is to
                    create an afforable and efficient way for consumers to purchase shoes.
                    With our great and vast catalogue of available footwear, you will be able to find the pair that best
                    suit you at the price that fits your budget. <br><br>

                    To get started, create an account and search for the shoes you need. When you're done, we will ring
                    you up, ship it out and you will receive your new pair in no time. <br><br>
