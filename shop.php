...
File Name: shop.php
Description: This file is shop page
  -->
        ...
        <div class="collapse navbar-collapse" id="navbar">
            ...
            <ul class="navbar-nav ml-1">
                ...
                <li class="nav-item ml-1">
                    ...
                    <a title="logout" href="logout.php?logout=1" class="btn btn-light btn-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="section-heading">
                    <h2>Men's Latest</h2><span>Check out our latest Men's products.</span>
                </div>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="#" class="text-decoration-none" target="_blank">
                        <img src="https://cdn.shopify.com/s/files/1/0037/0658/5123/products/jet-black1-fix_1024x1024@2x.jpg?v=1614409071"
                            alt="MenLatest1" style="width:100%">
                        <div class="caption">
                            <p class="text-dark">Jet Black</p>
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="#" class="text-decoration-none" target="_blank">
                        <img src="https://cdn.shopify.com/s/files/1/0037/0658/5123/products/1_6aa1ff2d-4cd9-4fce-9850-c4c4d94eeecd_1024x1024@2x.jpg?v=1602343465"
                            alt="MenLatest2" style="width:100%">
                        <div class="caption">
                            <p class="text-dark">Steel Onyx</p>
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <a href="#" class="text-decoration-none" target="_blank">
                        <img src="https://cdn.shopify.com/s/files/1/0037/0658/5123/products/0_f5daaae9-319d-464b-aa12-6e2ff5134b58_1024x1024@2x.jpg?v=1602342288"
                            alt="MenLatest3" style="width:100%">
                        <div class="caption">
                            <p class="text-dark">Cosmic Black</p>
