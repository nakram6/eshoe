...
<div class = "container">
    <br>
    <h2 class = "text-center"> Contact</h2> <br> <span class = "text-center"> Get in touch with us for any of your questions or concerns.</span>
    <br> <br>
  <div class="row">
      <div class="col">
          <div class="card">
            <div class="card-body">
              <div class="inputbox"> <input type="text" class="form-control" name="Name" required> <span> Full Name </span> </div>
              <div class="row">
                  <div class="col-md-6">
                      <div class="inputbox mt-3"> <input type="text" class="form-control" name="E-mail" required> <span>E-mail Address</span> </div>
                  </div>
                  <div class="col-md-6">
